...
impl<'db> BenchWriteTransaction for CanopydbBenchWriteTransaction<'db> {
...
impl<'txn> BenchReader for CanopydbBenchReader<'txn> {
...
impl<'tree> BenchIterator for CanopydbBenchIterator<'tree> {
    type Output<'out> = canopydb::Bytes where Self: 'out;
